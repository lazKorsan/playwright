package Utilities.LoyalFriendCare.lylTest.dorduncu20;

import Utilities.DimensonsUtils;
...
public class US062DragAndDrop {
    ...
    @Test
    public void test01(){
        System.out.println("US062 Test 01 Çalıştı");

        Page page = DimensonsUtils.setUpFullScreen("chrome", "https://the-internet.herokuapp.com/drag_and_drop");
