...
public class US059Succes {
    ...
    public void test01() {
        ...
        // todo buradan sonra bir mesaj çıkıyor
        //  mesajın ilk başında "You have selected :" yazısı var ve
        //  sonra seçimlere göre değişen bir mesaj
        //  bu mesajda
        //  toplam 17 tane locater ve hepsi 1 er artarak gidiyor
        // ilk yazının locati  (//*[@class='text-success'])[1]  ve yazı karşılığı "home"
        // sonuncu yazının locati (//*[@class='text-success'])[17] ve yazı karşığı "excelFile"
        // *** ACABA BURADA BU YAZILARI BİRLEŞTİRİP CONSOLA DİNAMİK OLARAK YAZDIRABİLME İMKANI VAR MI ***
    ...
    @Test
    public void test02() {
        System.out.println("US059 Test 02 Çalıştı");
